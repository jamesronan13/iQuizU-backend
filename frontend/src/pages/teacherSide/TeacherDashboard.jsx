          ...
          <div className="bg-background rounded-3xl shadow-md border border-gray-100 p-8 min-h-[400px] font-Outfit">
            {isMainDashboard ? (
              <div className="px-2 py-6 md:p-8 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 animate-slideIn">

                  <div className="bg-components p-6 m-4 rounded-2xl shadow hover:shadow-lg transition">
                    <div className="flex flex-row">
                      <School className="h-6 w-6 mr-2 text-blue-500 animate-bounceIn" />
                  ...
                  <div className="bg-components p-6 m-4 rounded-2xl shadow hover:shadow-lg transition">
                    <div className="flex flex-row">
                      <NotebookPen className="h-6 w-6 mr-2 text-blue-500 animate-bounceIn" />
                      <h1 className="text-xl font-semibold mb-2 text-title">
                        Quizzes
                      </h1>
                    </div>
                  ...
                  <div className="bg-components p-6 m-4 rounded-2xl shadow hover:shadow-lg transition [animation-delay:200ms]">
                    <div className="flex flex-row">
                      <Users className="h-6 w-6 mr-2 text-blue-500 animate-bounceIn" />
                      <h1 className="text-xl font-semibold mb-2 text-title">
                        Students
                      </h1>
                    </div>
